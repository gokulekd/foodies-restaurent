...
import 'package:foodies_restaurent/view/pages/History/show_history_orders.dart';
import 'package:foodies_restaurent/view/widgets/show%20more%20commen%20widget/OrderList_widget.dart';

class ScreenHistoryPage extends StatelessWidget {
  const ScreenHistoryPage({Key? key}) : super(key: key);
        ...
        body: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return OrderListWidget(
              visibilityForDeliveryStatus: true,
              onPressed: (){ Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) =>  const ShowHistoryOrders()));},
              buttonName: "See order History",
